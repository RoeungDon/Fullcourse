...
// Aliases so existing Signin/Signup keep working
export const signup = apiSignUp;
export const signin = apiSignIn;
export const signout = apiSignOut;
export const verify = apiVerify;
export const sendVerificationEmail = apiSendVerificationEmail;
export const sendResetPasswordEmail = apiSendResetPasswordEmail;
